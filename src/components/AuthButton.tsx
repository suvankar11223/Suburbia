...
import { FaCartShopping, FaPlus, FaUser } from "react-icons/fa6";
...
export type AuthButtonProps = {
  ...
  size?: "sm" | "md" | "lg";
  icon?: "cart" | "skateboard" | "plus" | "user";
  className?: string;
...
export function AuthButton({
  ...
  return (
    <button
      ...
      disabled={isLoading}
      className={clsx(
        "button-cutout group mx-4 inline-flex items-center bg-gradient-to-b from-25% to-75% bg-[length:100%_400%] font-bold transition-[filter,background-position] duration-300 hover:bg-bottom disabled:opacity-50 disabled:cursor-not-allowed",
